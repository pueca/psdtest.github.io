...
if (preg_match('/page/', $ref)) { ?>
         <center><a href="<?php echo $ref ?>">zurück</a></center> <?php 
}

else { ?>
         <center><a href="index_de.php">zurück</a></center> <?php

}   

 $newsx = mysql_fetch_array($news); ?>
          <div class="newz">
              <div class="newztitle"><?php  echo $newsx['title_de']; ?></br></div>
              <div class="newzdate"><?php  echo $newsx['date_created']; ?></br></div>
              <div class="newzcontent"><?php  echo $newsx['content_de']; ?></br></div>
