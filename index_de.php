...
?> 
    <body>
        ...
        <div class="ezik"><div class="text">Sprache</div>
...
?> 
       <div class="novinki">
           ...
           <div class="zaglavie"><?php echo $row['title_de']; ?></div>
           <div class="opisanie"><?php echo $row['description_de']; ?></div>
<div class="sudurjanie"><a href="/novini/news_de.php?id=<?php echo $row['id']; ?>"></div>
                <?php echo "alle Informationen" ?></a><br/> </div>
</div>
...
for ($i=1; $i<=$total_pages; $i++) { 
    ?> <div class="stranici"><?php echo  "<a href='index_de.php?page=".$i."'>".$i."</a>"; ?></div>
    <?php
}
?>
