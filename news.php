...
if (preg_match('/page/', $ref)) { ?>
         <center><a href="<?php echo $ref ?>">Назад</a></center> <?php 
}

else { ?>
         <center><a href="index.php">Назад</a></center> <?php
}   
$newsx = mysql_fetch_array($news); ?>
         <div class="newz">
             <div class="newztitle"><?php  echo $newsx['title_bg']; ?></br></div>
             <div class="newzdate"><?php  echo $newsx['date_created']; ?></br></div>
             <div class="newzcontent"><?php  echo $newsx['content_bg']; ?></br></div>
